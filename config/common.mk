...
PRODUCT_COPY_FILES += \
    ...
    vendor/validus/config/permissions/privapp-permissions-gzosp-product.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/privapp-permissions-gzosp.xml
...
PRODUCT_VERSION_MAINTENANCE = 7.10
